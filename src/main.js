...
import { captureBigoAttribution, getStoredBigoPixelId } from './shared/analytics/bigoAttribution'
...
bigoPixelManager.init({
  pixelId: bigoAttribution?.pixelId || getStoredBigoPixelId(),
})
...
const shouldClearDevServiceWorker =
  'serviceWorker' in navigator && import.meta.env.DEV && shouldDisableServiceWorker
